...
/// using a <see cref="PageTransition"/> to move between the old and new content. <br/>
/// <br/>
/// Note:<br/>
/// <b>Workaround</b> until https://github.com/AvaloniaUI/Avalonia/pull/13003 is merged and released
/// </summary>
[PseudoClasses(_PcReversed)]
internal class ReversableTransitioningContentControl : ContentControl
{
