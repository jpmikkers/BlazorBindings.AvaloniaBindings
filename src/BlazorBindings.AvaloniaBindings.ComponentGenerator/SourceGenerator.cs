    ...
    public class SourceGenerator : IIncrementalGenerator
    {
        private static readonly ComponentWrapperGenerator componentWrapperGenerator = new(
            new GeneratorSettings
            {
                FileHeader = @"//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a BlazorBindings.AvaloniaBindings component generator.
//
...
"
        ...
        static GeneratedComponentInfo GetSemanticTargetForGeneration(GeneratorSyntaxContext context)
        {
            ...
            if (attributeTypeSymbol?.ToDisplayString() != "BlazorBindings.AvaloniaBindings.ComponentGenerator.GenerateComponentAttribute")
                return null;
